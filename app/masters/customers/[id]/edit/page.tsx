...
export default function EditCustomerPage() {
  ...
  return (
    <div className="space-y-6">
      <Link href="/app/masters/customers" className="flex items-center gap-2 text-blue-600 hover:text-blue-900">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <select {...register('customer_type')} className="w-full px-3 py-2 border border-gray-300 rounded-md" disabled={isSaving}>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input {...register('credit_limit', { valueAsNumber: true })} type="number" className="w-full px-3 py-2 border border-gray-300 rounded-md" disabled={isSaving} />
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <Link href="/app/masters/customers" className="border border-gray-300 px-6 py-2 rounded-lg hover:bg-gray-50">Cancel</Link>
          </div>
        </form>
      </div>
    </div>
